...
- Redis 도입 전:
  > Lock 경합, 요청 지연, Connection Pool 소진 발생
- Redis 도입 후:
  > TPS 향상, 지연 제거, 안정적 재고 흐름

*(Placeholder: Redis Before/After 성능 그래프 & 영상)*
